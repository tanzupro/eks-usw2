...
echo
echo Continue to create GitHub TAP GitOps Repo eks-usw2
echo     https://github.com/tanzupro/eks-usw2
echo
...
git add .
git commit -am "."
gh repo create eks-usw2 --private
git remote add origin https://github.com/tanzupro/eks-usw2
git branch -M main
